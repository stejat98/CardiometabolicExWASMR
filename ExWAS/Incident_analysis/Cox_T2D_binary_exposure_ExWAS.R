...
EWASCoxph(data=data, depvar = "t2d"
          ,adjustments = adjustments,exposures=exposures,outFileName = sprintf("Coxph_Binary_Exposures_Baseline_Actual_06_28_23_Baseline_Pheno%sOverall_biglm_results", "T2D"))
